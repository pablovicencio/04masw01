...
<?php
	...
	$id = $_POST["idiomaid"];
	$idiomaDelete = borraridioma($id);
	
	if($idiomaDelete){
	?>
		<div class="row">
			<div class="alert alert-success" role="alert">
				idioma borrado correctamente,<a href="lista.php"> regresar al listado de idiomas</a>
			</div>
		</div>
	<?php	
	}else{
		...
		<div class="row">
			<div class="alert alert-success" role="alert">
				idioma no se a borrado correctamente,<a href="lista.php"> volver a intentarlo</a>
			</div>
		</div>
		<?php
	}
