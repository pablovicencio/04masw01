...
<div class="col-12">
	<form name="crear_plataforma" action="" method="POST">
		<div class="mb-3">
			<input name="Nombre" type="text" placeholder="Especifique el nombre del director" value="<?php echo $plataforma->Nombre?>" required/>
		</div>
...
<?php
	...
	if(isset($_POST['BotonEditar'])){
		...
		$plataformaNuevo = editPlataforma($ID,$nombre);
