...
<?php
	...
	$id = $_POST["directorid"];
	$directorDelete = borrarDirector($id);
	
	if($directorDelete){
	?>
		<div class="row">
			<div class="alert alert-success" role="alert">
				Director borrado correctamente,<a href="lista.php"> regresar al listado de directores</a>
			</div>
		</div>
	<?php	
	}else{
		...
		<div class="row">
			<div class="alert alert-success" role="alert">
				Director no se a borrado correctamente,<a href="lista.php"> volver a intentarlo</a>
			</div>
		</div>
		<?php
	}
