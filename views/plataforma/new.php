...
<head>
  <meta charset="UTF-8">
  <title>04MASW | Trabajo 01 | Crea una Plataforma</title>
</head>
<body>
...
<?php
	...
	if(isset($_POST['BotonCrear'])){
		...
		$plataformaNuevo = nuevaPlataforma($nombre);
...
<div class="col-12">
	<form name="crear_plataforma" action="" method="POST">
		<div class="mb-3">
			<input name="Nombre" type="text" placeholder="Especifique el nombre" required/>
		</div>
