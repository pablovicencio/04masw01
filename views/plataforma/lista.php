...
<head>
  <meta charset="UTF-8">
  <title>04MASW | Trabajo 01 | Lista de Plataformas</title>
</head>
<body>
...
<div class="col-12">
	...
	$plataformaList = listarPlataforma();

	if (count($plataformaList) > 0) {
	?>
		<table class="table">
			<thead>
				<th>Id</th>
			...
			<tbody>
				<?php
				foreach ($plataformaList as $plataforma) {
				?>
					<tr>
						...
						<td>
							<div class="btn-group" role="group" aria-label="Basic example">
								<a class="btn btn-success" href="editar.php?ID=<?php echo $plataforma->getid();?>">Editar</a>
								
								<form name="delete_director" action="delete.php" method="POST" style="...">
									<input type="hidden" name="directorid" value="<?php echo $plataforma->getid();?>"/>
